...
if modify:
    ...
    # Create an expander to hold the dynamic filters neatly
    with st.expander("Filter columns", expanded=True):
        ...
        for column in to_filter_columns:
            ...
            # If the column is numeric, show a slider range
            ...
            # If the column is text/categorical, show a multi-select box
            else:
